  ...
  <div class="form-card">
    ...
    <form method="POST" action="index.php?page=plans">
      <div class="form-row">
        ...
        <div class="form-group"><label>Speed</label><input name="speed" required></div>
        <div class="form-group"><label>Price (RWF/month)</label><input name="price" type="number" step="500" required></div>
      </div>
      <div class="form-row">
